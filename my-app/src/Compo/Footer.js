...
function Footer() {
  return (
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright 2022 <strong><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-badge-cc" viewBox="0 0 16 16">
  ...
  <path d="M14 3a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h12zM2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2z"/>
      ...
      <div class="credits">
        Made and Designed by Narendra Kumar Jha
      </div>
    </div>
  </footer></div>
  )
